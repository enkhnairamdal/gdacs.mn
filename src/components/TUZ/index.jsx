...
export default function Tuz() {
    ...
    return(
        <div className={styles.slidercon}>
           ...
           <div>
            <p className={styles.top} ><span className={styles.bold} >Ажлын туршлага:</span>  Шинкү констракшн холдингс ХХК Менежер / 2014 - 2017 / <br /> Кумо-Элиди ХХК Орчуулагч / 2014 - 2015 / </p>
           ...
           <div>
            <p className={styles.top} ><span className={styles.bold} >Ажлын туршлага:</span> Дунху трейд ХК  Менежер / 1991 - 2001 / <br />    Хайэр Корэа  Захирал / 2001 - 2008 / </p>
            <p><span className={styles.bold} >Боловсрол:</span> Ерөнхий боловсрол Гэсон ахлах сургууль / - 1981 / <br /> Ённамын ИС Инженер / 1981 - 1985 / </p>
            <img src="./image/lee.jfif" alt="" />
            <h3>Лий Жунху</h3>
            <p className={styles.pa}>Иргэний харьяалал: БНСУ <br /> Эм Ди Кэй Ай ХХК / Захирал
                                 </p>
           </div>
           <div>
            <p className={styles.top} ><span className={styles.bold} >Ажлын туршлага:</span> Эм Ди Кэй Ай ХХК Нягтлан бодогч / 2020 - /</p>
           ...
           <div>
            <p className={styles.top} ><span className={styles.bold} >Ажлын туршлага:</span> МИАТ ТӨХК Мэргэжилтэн / 2011 - /</p>
            <p><span className={styles.bold} >Боловсрол:</span> МУИС Эрх зүйч / 1994 - 1998 /  </p>
            <img src="./image/ganchimeg-removebg-preview.jpg" alt="" />
            <h3>Л.Ганчимэг </h3>
            <p className={styles.pa}>МИАТ ТӨХК / Мэргэжилтэн</p>
           </div>
           <div>
            <p className={styles.top} ><span className={styles.bold} >Ажлын туршлага:</span> Гутлын үйлдвэр Оёдолчин / 1989 - 1990 / <br /> Гутлын үйлдвэр Мастер / 1994 - 1995 /  </p>
            <p><span className={styles.bold} >Боловсрол:</span> Ерөнхий боловсрол Нийслэлийн тэргүүний 33-р дунд сургууль / 1977 - 1987 / <br /> Чех улс АҮС Оёдлын технологи Оёдлын технологич / 1990 - 1994 /  </p>
