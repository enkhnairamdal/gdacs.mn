        ...
        <div className={styles.abcontainer}>
            ...
            <div className={styles.sec2}>
                ...
                <div className={styles.cards}>
                    <div className={styles.card1} style={{display:"flex", gap:"50px" , justifyContent:"center"}}>
                    ...
                    <div className={styles.card}>
                    <img src="./image/web-development-agency-singapore-website-development-process-medium.jpg" alt="" />
                    <p>Веб Сайтын Үйлчилгээ</p>
                    <span>&#8212;</span>
                    </div>
                    <div className={styles.card}>
                    <img src="./image/insights-value-of-assessing-your-it-operations.jpg" alt="" />
